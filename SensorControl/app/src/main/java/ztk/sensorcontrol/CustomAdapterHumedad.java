...
public class CustomAdapterHumedad extends BaseAdapter {

    Context context;
    ArrayList<Humedad> rowItem;

    CustomAdapterHumedad(Context context, ArrayList<Humedad> rowItem) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.lista_hum, null);
