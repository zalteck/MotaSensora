...
public class CustomAdapterLuz extends BaseAdapter {

    Context context;
    ArrayList<Luz> rowItem;

    CustomAdapterLuz(Context context, ArrayList<Luz> rowItem) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.lista_luz, null);
